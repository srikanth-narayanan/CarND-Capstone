...
class Controller(object):
    def __init__(self, vehicle_mass, wheel_radius, wheel_base, steer_ratio,
        ...
        self.pid_accel = PID(kp=0.9, ki=0.9, kd=0.0, mn=decel_limit, mx=accel_limit)
        # Lowpass filter for Steering
        self.lowpass_steering = LowPassFilter(0.2, 0.9)
        #Low pass filter for throttle
        self.lowpass_throttle = LowPassFilter(0.9, 1.0)
